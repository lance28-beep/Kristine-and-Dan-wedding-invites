...
// Theme: same as love-story / gallery (navy, champagne, muted gold)
const CHAMPAGNE = '#F5E6D3';
const MUTED_GOLD = '#C6A85E';
const NAVY_PANEL = '#072142';
const NAVY_LAYERS = ['#072142', '#0C2650', '#08467F', '#072142'] as const;
...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  className,
  menuButtonColor = CHAMPAGNE,
  openMenuButtonColor = CHAMPAGNE,
  changeMenuColorOnOpen = true,
  accentColor = MUTED_GOLD,
  isFixed = false,
  onMenuOpen,
  onMenuClose
}: StaggeredMenuProps) => {
    ...
    >
      ...
      >
        ...
        <aside
          ...
          style={{ background: NAVY_PANEL, WebkitBackdropFilter: 'blur(12px)' }}
          aria-hidden={!open}
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-6">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium" style={{ color: 'var(--sm-accent, ' + MUTED_GOLD + ')' }}>Socials</h3>
                <ul
...
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; gap: 0.3rem; background: transparent; border: none; cursor: pointer; color: #F5E6D3; font-weight: 500; line-height: 1; overflow: visible; }
.sm-scope .sm-toggle:focus-visible { outline: 2px solid rgba(245, 230, 211, 0.8); outline-offset: 4px; border-radius: 4px; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #072142; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6.5em 2.25em 2.25em 2.25em; overflow-y: auto; z-index: 10; }
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1.05rem; font-weight: 500; color: var(--sm-accent, #C6A85E); }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #C6A85E); outline-offset: 3px; }
.sm-scope .sm-socials-link { font-size: 1rem; font-weight: 500; color: #F5E6D3; text-decoration: none; position: relative; padding: 2px 0; display: inline-block; transition: color 0.3s ease, opacity 0.3s ease; }
...
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #C6A85E); }
.sm-scope .sm-panel-title { margin: 0; font-size: 1rem; font-weight: 600; color: #C6A85E; text-transform: uppercase; }
.sm-scope .sm-panel-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 0.75rem; }
.sm-scope .sm-panel-item { position: relative; color: #F5E6D3; font-weight: 600; font-size: 2.1rem; cursor: pointer; line-height: 1.1; letter-spacing: -1px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
...
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #C6A85E); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--sm-accent, #C6A85E); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }

export const siteConfig = {
  couple: {
    bride: "Kristine Lei Rivera",
    brideNickname: "Kristine",
    groom: "Dan Jacob Resurreccion",
    groomNickname: "Dan",
  },
  wedding: {
    date: "MAY 23, 2026",
    time: "2:00 PM",
    venue: "Mere Monique Home Chapel, St. Paul's Monastery",
  ...
  ceremony: {
    location: "Mere Monique Home Chapel, St. Paul's Monastery",
  ...
  reception: {
    ...
    address: "Benigno Aquino Diversion Road, Mandurriao, Iloilo City",
    venue: "JR Hall, Diversion 21 Hotel",
    date: "May 23, 2026",
